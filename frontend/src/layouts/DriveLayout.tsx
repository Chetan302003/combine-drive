  ...
  return (
    <aside className="flex h-full w-64 flex-col border-slate-200/60 bg-slate-50/40 backdrop-blur-xl p-4 lg:border-r">
      <div className="flex items-center gap-2.5 pb-3 pt-1">
        ...
        <span className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Combine Drive</span>
      </div>
            ...
            <div className="flex items-center justify-between gap-3 lg:hidden">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="flex min-w-0 items-center gap-2">
                  ...
                  <span className="truncate text-xl font-extrabold tracking-tight">Combine Drive</span>
                </div>
              </div>
